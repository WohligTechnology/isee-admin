myApp.controller('DashboardCtrl', function ($scope, TemplateService, NavigationService, $timeout) {
    ...
    .controller('exceptionReportCtrl', function ($scope, TemplateService, NavigationService, $timeout) {
        $scope.template = TemplateService.getHTML("content/exception-report.html");
        TemplateService.title = "Exception Report"; //This is the Title of the Website
        TemplateService.class = "exception-report"; //This is the Class of the Theme
        TemplateService.templateTitle = ""; //This is the Title of the Theme
        $scope.navigation = NavigationService.getNavigation();
    })
